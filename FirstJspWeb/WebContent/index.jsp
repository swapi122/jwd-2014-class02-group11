...
<body>
	<div id="menu">
		<li class="list-group-item" id="time"
			style="font-size: 11px; background-color: #3b5998; font-weight: bold; color: rgb(250, 250, 250);"></li>
		<li class="list-group-item"
			...
			class="list-group-item "><span class="pull-right"><i
				class="icon-chevron-right"></i></span>Thông tin sinh viên</a>
		<hr>
					...
					<div class="col-md-9">
						...
						<div class="well-sm">
							<span> <span id="random_tin"> <i
									...
									src="./images/bullet-blue-icon.png"> <small> <a
										href=""> Thông báo giảng viên đã thêm đề tài mới, tất cả
											các sinh viên lớp 111101 vào xem chi tiết để bắt đầu làm bài.
											<small style="color: rgb(87, 87, 87);"></small>
									</a>
