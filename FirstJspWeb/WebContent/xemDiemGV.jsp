							...
							<div id="desktop-menu">
								<div class="panel panel-default">
									...
									<a href="index.jsp"
										...
										class="list-group-item "><span class="pull-right"></span><a1>Xem điểm</a1></a> 
										<a href=""
...
<FORM>
Mã đề tài: <select><option>DT01</option> <option>DT02</option></select> <input type="button" name="xemdiem" value="Xem Điểm"/>
<p> </p>
 <div>
