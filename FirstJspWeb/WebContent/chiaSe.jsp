					...
					<div class="breadcrumb" id="container">
						<div id="demo_jui">
							<table id="companies" class="display">
								<thead>
									<tr>
										<th>Chia sẻ Concept map</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>Chọn sinh viên cùng đề tài
											<div id="search">
												<select class="form-control text-center" id="search_cn">
													<option value="" selected="">Trương Văn An</option>
													<option value="">Võ Thị Hồng</option>
													<option value="">Phạm Hoàng Hải</option>
													<option value="">Đỗ Công Hải</option>
												</select>
											</div> <br>
											<button class="btn" type="button" onclick="">Chia
												sẻ</button>
										</td>
									</tr>
								</tbody>
