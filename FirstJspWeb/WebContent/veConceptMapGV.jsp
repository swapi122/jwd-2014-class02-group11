	...
	<div id="menu">
		...
		<li class="list-group-item"
			...
			Mục</li> <a href="index.jsp"
										...
										class="list-group-item "><span class="pull-right"></span><a1>Vẽ Concept Map</a1></a>
										<a href="trangGV.jsp"
			...
			<div class="container">
				...
				<div class="col-md-9">
					<ol class="breadcrumb">
						...
						<li class="active">Vẽ ConceptMap</li>
					</ol>
					...
					<div class="panel panel-default">
						<div style="color: rgb(7, 132, 163);" class="panel-heading">
							<h4 style="font-family: verdana; color: rgb(87, 87, 87);"></h4>
								<FORM>
								<P>Nhập tên ConceptMap:<INPUT TYPE="text" NAME="tenConceptMap"></P>
								<P>Tài liệu:<INPUT TYPE="file" NAME="taiLieu"></P>
								<P><INPUT TYPE="submit" VALUE="Lưu"> <INPUT TYPE="reset" VALUE="Làm lại"></P>
