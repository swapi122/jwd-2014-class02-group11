	...
	<div id="container">
		<div id="mobile-bar">
			<span style="cursor: pointer;" class="pull-left" href="javascript:;"
				...
				Out</span>
			<p style="text-align: center; font-weight: bold;">SV: Phạm Văn
				A</p>
		</div>
		<div id="navigation">
			<div id="banner-desktop">
				<div class="container">
					<div id="banner">
						<div id="login-area">
							<a data-toggle="modal" href="#thong_tin"><i>SV </i>: 
								Pham Văn A</a>
						</div>
					</div>
				</div>
			...
			<div class="container">
							...
							<div id="desktop-menu">
								<div class="panel panel-default">
									...
									<a href="index.jsp" class="list-group-item "><span
										...
										danh sách đề tài</a> <a href="danhSachDiem.jsp"
										class="list-group-item "><span class="pull-right"></span>Xem điểm</a> <a href = "xemBaiDuocShare.jsp" class="list-group-item "><span
										class="pull-right"></span>Xem bài được share</a>
								</div>
								<!-- /panel-default -->
				...
				<div class="col-md-9">
					<ol class="breadcrumb">
						...
						<li class="active">Sinh viên vẽ ConceptMap</li>
					</ol>

					<div class="panel panel-default">
						<div style="color: rgb(7, 132, 163);" class="panel-heading">
							<h4 style="font-family: verdana; color: rgb(87, 87, 87);"></h4>
							<FORM>
								<P>
									Nhập tên ConceptMap:<INPUT TYPE="text" NAME="tenConceptMap">
								</P>
								<P>
								...
								<button type ="button" onclick="">Chia sẻ</button>							
								</p>
